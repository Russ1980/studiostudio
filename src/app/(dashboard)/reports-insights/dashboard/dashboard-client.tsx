...
import { DollarSign, BarChart2, Wand2, SlidersHorizontal, BrainCircuit } from "lucide-react";
       ...
       <Card className="bg-primary/5 border-primary/20">
        ...
        <CardContent className="space-y-4">
            {insights.map((insight, index) => (
             ...
             {insights.length === 0 && (
                <p className="text-sm text-muted-foreground">No insights generated. Check back later.</p>
            )}
        </CardContent>
       </Card>
    </div>
