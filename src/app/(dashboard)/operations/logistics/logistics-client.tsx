...
export function LogisticsClientPage({ shipments }: { shipments: any[] }) {
  const kpiData = [
                ...
                <TableBody>
                    {shipments.map((shipment) => (
                        <TableRow key={shipment.id}>
                            ...
                            <TableCell><Badge variant={statusVariant[shipment.status as keyof typeof statusVariant]}>{shipment.status}</Badge></TableCell>
