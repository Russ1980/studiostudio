...
export default function DashboardPage() {
    ...
    const { user, mainKpis, navItems } = dashboardData;
    const [activeView, setActiveView] = useState('Executive Overview');

    const renderView = () => {
        switch (activeView) {
            case 'Executive Overview':
                return <ExecutiveOverviewView data={dashboardData} />;
            case 'Financial Health':
                return <FinancialHealthView data={dashboardData.financialHealthData} />;
            case 'Serva AI Insights':
                return <ServaAIInsightsView data={dashboardData.servaAiInsightsData} />;
            case 'Workflow Hub':
                return <WorkflowHubView data={dashboardData.workflowHubData} />;
            case 'Process Visibility':
                return <ProcessVisibilityView data={dashboardData.processVisibilityData} />;
            case 'Business Context':
                return <BusinessContextView data={dashboardData.businessContextData} />;
