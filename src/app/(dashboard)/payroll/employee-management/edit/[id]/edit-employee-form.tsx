...
export function EditEmployeeForm({ employee }: { employee: z.infer<typeof EmployeeSchema> }) {
  ...
  const onSubmit = (values: z.infer<typeof EmployeeSchema>) => {
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        toast({ title: "Error updating employee", description: result.error, variant: "destructive" });
      }
    });
  };
    ...
    <Form {...form}>
        ...
        <Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
                ...
                <FormField control={form.control} name="salary" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Annual Salary</FormLabel><FormControl><Input type="number" {...field} /></FormControl><FormMessage /></FormItem>)} />
            </CardContent>
