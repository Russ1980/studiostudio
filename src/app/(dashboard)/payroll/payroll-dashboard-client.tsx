...
export function PayrollDashboardClientPage({ initialData }: { initialData: any }) {
    ...
    const getIcon = (title: string) => {
        switch (title) {
            case "Total Gross Pay (YTD)": return DollarSign;
            case "Total Net Pay (YTD)": return DollarSign;
            case "Total Tax Liability (YTD)": return Shield;
            case "Active Employees": return Users;
