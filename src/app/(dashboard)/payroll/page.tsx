...
const kpiData = [
  {
    title: "Total Gross Pay (YTD)",
    value: "$4.8M",
    icon: DollarSign,
  },
  {
    title: "Total Net Pay (YTD)",
    value: "$3.5M",
    icon: DollarSign,
  },
  {
            ...
            <CardContent className="space-y-3">
                {upcomingDeadlines.map((deadline, index) => (
                    <div key={index} className="flex items-center gap-4">
                        ...
                        <Badge variant={priorityVariant[deadline.priority]} className="h-fit">{deadline.priority}</Badge>
                    </div>
                ))}
            </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm text-muted-foreground">
                        <span>Next Step: Final Approval</span>
                        <span>73 Employees</span>
                    </div>
                </CardContent>
                <CardFooter>
